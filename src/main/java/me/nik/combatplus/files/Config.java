...
public class Config {
    ...
    public void addDefaults() {
        ...
        get().addDefault("advanced.settings.modifiers.old_swords_damage", 1);
        get().addDefault("advanced.settings.modifiers.old_shovels_damage", -0.5);
        get().addDefault("advanced.settings.modifiers.old_axes_damage", -2);
        get().addDefault("advanced.settings.modifiers.old_pickaxes_damage", 1);
